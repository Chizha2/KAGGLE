...
x_train, x_test, y_train, y_test = train_test_split(file.drop(columns = ['LUX']), file['LUX'], test_size = 0.25) # разделение на 4 части (2 тестовых и 2 валидационных)
...
print(rmsle(y_real, y_predict))
graph_print2(y_real, y_predict)
